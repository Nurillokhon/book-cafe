  ...
  en: {
    translation: {
      ...
      orderModal: {
        ...
        startTelegram: "Open Telegram and press /start (order status)",
        submit: "Submit order",
  ...
  uz: {
    translation: {
      ...
      orderModal: {
        ...
        startTelegram: "Telegramga o‘tish va /start bosish (holat uchun)",
  ...
  ru: {
    translation: {
      ...
      orderModal: {
        ...
        startTelegram: "Открыть Telegram и нажать /start (статус заказа)",
