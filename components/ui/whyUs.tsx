...
const WhyUs = () => {
    ...
    return (
        <section className="relative overflow-hidden bg-[#1F3A34]/90 bg-[url('/images/about.jpg')] bg-cover bg-center bg-no-repeat bg-scroll py-14 sm:py-16 md:bg-fixed">
            ...
            <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {items.map(({ title, text, Icon }) => (
                        <div
                            key={title}
                            className="group relative overflow-hidden rounded-3xl border border-white/10 bg-[#0f1f1b]/55 p-5 backdrop-blur transition hover:bg-[#0f1f1b]/65 sm:p-6"
                        >
                            <div
